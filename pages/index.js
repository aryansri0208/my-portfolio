...
const projects = [
  {
    ...
    title: "Grocio",
    description:
      "AI-based smart pantry management app that tracks groceries, recommends recipes based on pantry contents, and sends notifications for restocking and expiration dates. Built with Flutter, Firebase, and OpenAI GPT.",
...
function HeroSection() {
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 max-w-6xl mx-auto pt-24">
      ...
      >
        ...
        <div className="flex-1">
          ...
          <h1 className="font-serif text-[clamp(3.5rem,10vw,8rem)] text-[#e8e0d4] leading-[0.95] mb-10 tracking-tight">
            Aryan
            <br />
            <span className="text-[#3a3530]">Srivastava</span>
          </h1>

          <p className="text-[#5a5450] text-base md:text-lg max-w-lg leading-relaxed mb-12">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <a
                ...
                aria-label="GitHub"
                className="text-[#3a3530] hover:text-[#c9a96e] transition-colors duration-200"
              >
      ...
      >
        <span className="font-mono text-[10px] tracking-[0.25em] uppercase text-[#2a2520]">
          Scroll
        </span>
        <div className="w-px h-10 bg-gradient-to-b from-[#2a2520] to-transparent" />
      </motion.div>
    </section>
  );
}
          ...
          <button
            ...
            className={`font-mono text-[11px] tracking-[0.18em] uppercase px-4 py-2 border transition-colors duration-200 ${
              active === cat
                ...
                : "border-[#1e1e1e] text-[#5a5450] hover:border-[#3a3530] hover:text-[#a09890]"
            }`}
          >
            {cat}
          </button>
        ...
        {performances.map((perf, i) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <p className="text-[#5a5450] text-xs leading-relaxed">
                {perf.description}
              </p>
            </div>
          </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {beyond.map((item, i) => (
          ...
          >
            ...
            <p className="text-[#5a5450] text-sm leading-relaxed">
              {item.description}
            </p>
          </motion.div>
        ))}
  ...
  return (
    <footer className="py-12 px-6 max-w-6xl mx-auto border-t border-[#1e1e1e]">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <span className="font-serif text-[#2a2520]">Aryan Srivastava</span>
        <div className="flex items-center gap-6">
          <a
            href="https://www.linkedin.com/in/aryan-srivastava-9b1664185/"
            target="_blank"
            rel="noopener noreferrer"
            className="font-mono text-[11px] tracking-[0.14em] text-[#2a2520] hover:text-[#c9a96e] transition-colors duration-200"
          >
            LinkedIn
          </a>
          <a
